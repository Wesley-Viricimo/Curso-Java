...
public class ContaCorrente extends Conta {
    ...
    public ContaCorrente(Integer numero, String dono, double saldo, double limiteSaque, TipoConta tipoConta, TipoPessoa tipoPessoa) {
    ...
    public void saque(double valor) throws DomainException {
        if (valor > limiteSaque) {
            ...
            if (tipoPessoa == TipoPessoa.FISICA) {
                ...
                saldo = saldo - (valor * 0.15); //Pessoa jurídica terá um juros de 5% ao realizar saques da conta poupança
            }
        }
    }
